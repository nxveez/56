...
-- MODERN DARK GUI WITH BLUE STROKE (SMALLER)
...
MinimizeButton.Position = UDim2.new(1, -63, 0, 6)
MinimizeButton.Text = "–"
...
FloatingButton.Position = UDim2.new(1, -60, 0, 15)
FloatingButton.Text = "💫"
...
ToggleButton.Size = UDim2.new(0.85, 0, 0, 34)
...
DecreaseRadius.Size = UDim2.new(0.22, 0, 0, 34)
DecreaseRadius.Position = UDim2.new(0.075, 0, 0.58, 0)
DecreaseRadius.Text = "<"
...
IncreaseRadius.Size = UDim2.new(0.22, 0, 0, 34)
IncreaseRadius.Position = UDim2.new(0.705, 0, 0.58, 0)
IncreaseRadius.Text = ">"
...
RadiusDisplay.Size = UDim2.new(0.42, 0, 0, 34)
RadiusDisplay.Position = UDim2.new(0.29, 0, 0.58, 0)
...
Watermark.Text = "HANN.SIEXTHER"
Watermark.TextColor3 = Color3.fromRGB(70, 130, 255)
