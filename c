--// 🕊️ FLY GUI MODERN DARK BLUE - COMPACT VERSION
...
DPad.BackgroundColor3 = Color3.fromRGB(20, 20, 30)
...
local function createDPadBtn(txt, pos)
...
local UpBtn = createDPadBtn("W", UDim2.new(0.5, -22, 0, 8))
local DownBtn = createDPadBtn("S", UDim2.new(0.5, -22, 1, -53))
local LeftBtn = createDPadBtn("A", UDim2.new(0, 8, 0.5, -22))
local RightBtn = createDPadBtn("D", UDim2.new(1, -53, 0.5, -22))
