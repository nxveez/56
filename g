...
-- Saved emotes data
local savedEmotes = {}
local SAVE_FILE = "HannSiexther_SavedEmotes.json"
...
minimizeBall.Size = UDim2.new(0, scale("X", 60), 0, scale("Y", 60))
minimizeBall.Position = UDim2.new(0.9, -scale("X", 30), 0.1, 0)
minimizeBall.BackgroundColor3 = Color3.fromRGB(25, 25, 30)
minimizeBall.Text = "HAN"
minimizeBall.TextScaled = true
...
createCorner(minimizeBall, 30)
createStroke(minimizeBall, 2, Color3.fromRGB(70, 130, 255))
