...
Main.Position = UDim2.new(0.5, -130, 0.5, -107.5)
...
ContentFrame.Position = UDim2.new(0.05, 0, 0.16, 0)
ContentFrame.Size = UDim2.new(0.9, 0, 0.81, 0)
...
SearchBox.Size = UDim2.new(0.9, 0, 0.09, 0)
...
PlayerList.Size = UDim2.new(0.9, 0, 0.48, 0)
...
ButtonContainer.Position = UDim2.new(0.05, 0, 0.72, 0)
...
TargetInfo.Position = UDim2.new(0.05, 0, 0.635, 0)
TargetInfo.Size = UDim2.new(0.9, 0, 0.08, 0)
...
BringAllButton.Position = UDim2.new(0, 0, 0.55, 0)
BringAllButton.Size = UDim2.new(1, 0, 0.45, 0)
...
spawn(function()
	...
	if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
		...
		initializePartOrbit()
		print("✅ PartOrbit initialized (Radius: " .. radius .. ", Speed: " .. speed .. ")")
	end
end)